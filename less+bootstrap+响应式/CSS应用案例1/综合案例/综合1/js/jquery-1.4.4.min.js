...
(function (E, B) {
    ...
    c.extend({clean: function (a, b, d, e) {
        ...
        if (d)for (h = 0; f[h]; h++)if (e && c.nodeName(f[h], "script") && (!f[h].type || f[h].type.toLowerCase() === "text/javascript效果案例"))e.push(f[h].parentNode ? f[h].parentNode.removeChild(f[h]) : f[h]); else {
    ...
    c.extend({get: function (a, b, d, e) {
        ...
        getScript: function (a, b) {
            ...
            script: "text/javascript效果案例, application/javascript效果案例", json: "application/json, text/javascript效果案例", text: "text/plain", _default: "*/*"}}, ajax: function (a) {
    ...
    c.extend({active: 0, lastModified: {}, etag: {}, handleError: function (a, b, d, e) {
        ...
        if (typeof a === "string")if (b === "json" || !b && e.indexOf("json") >= 0)a = c.parseJSON(a); else if (b === "script" || !b && e.indexOf("javascript效果案例") >= 0)c.globalEval(a);
        return a
    }});
