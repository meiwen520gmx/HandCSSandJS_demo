myFocus.pattern.extend({//*********************tbhuabao******************
    'mF_tbhuabao': function (settings, $) {
        ...
        $dotList.each(function () {
            this.innerHTML = '<a href="javascript效果案例:;">&bull;</a>'
        });//小点
        var $prevBtn = $focus.addHtml('<div class="prev"><a href="javascript效果案例:;">&#8249;</a></div>');
        var $nextBtn = $focus.addHtml('<div class="next"><a href="javascript效果案例:;">&#8250;</a></div>');
        //CSS
